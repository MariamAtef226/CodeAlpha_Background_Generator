export default function Gradient({grad, handleGradient, handleDirection, direction}) {

    return (
        <>
            <div className="d-flex align-items-center mt-3 justify-content-between">
                <h6 className="me-2 me-md-4 text-start">Select Color 1:</h6>
                <input type='color' name='color1' value={grad.c1} onChange={handleGradient} />
            </div>

            <div className="d-flex align-items-center mt-2 justify-content-between">
                <h6 className="me-2 me-md-4 text-start">Select Color 2:</h6>
                <input type='color' name='color2' value={grad.c2} onChange={handleGradient} />
            </div>
